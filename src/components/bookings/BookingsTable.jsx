...
import DatesSlider from '../common/DatesSlider';

const BookingsTable = ({bookingInfo, handleBookingCancellation}) => {
    const [filterBookings, setFilterBookings] = useState(bookingInfo);

    const handleFilterBooking = (startDate, endDate) => {
    ...
    return (
        <section className='p-4'>
            <DatesSlider onDateChange={handleFilterBooking} onFilterChange={handleFilterBooking}/>
            ...
            {handleFilterBooking.length === 0 && <p>No booking found for selected date.</p>}
        </section>
    )
}
